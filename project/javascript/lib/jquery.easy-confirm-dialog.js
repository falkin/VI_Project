...
jQuery.fn.confirm = function(options) {
  ...
  return this.each(function() {
    ...
    var $cancel = jQuery(options.buttons.wrapper).append(options.buttons.cancel).attr("class","btNOk").click(function() {
      // Check if timeout is set.
      if (options.timeout != 0) {
        clearTimeout(timer);
      }
    ...
    var handler = function() {
      ...
      if (options.timeout != 0) {
       ...
       $dialog.attr("style","display:inline-block;margin-left: 10px;");
       $dialog.css("color", "#f33f52");
      return false;
    };
